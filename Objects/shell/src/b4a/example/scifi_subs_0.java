...
try {
		Debug.PushSubsStack("Activity_Create (scifi) ","scifi",4,scifi.mostCurrent.activityBA,scifi.mostCurrent,18);
...
try {
		Debug.PushSubsStack("Activity_Pause (scifi) ","scifi",4,scifi.mostCurrent.activityBA,scifi.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Activity_Resume (scifi) ","scifi",4,scifi.mostCurrent.activityBA,scifi.mostCurrent,24);
