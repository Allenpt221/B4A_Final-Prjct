...
try {
		Debug.PushSubsStack("ActionPage_Click (drama) ","drama",2,drama.mostCurrent.activityBA,drama.mostCurrent,628);
if (RapidSub.canDelegate("actionpage_click")) { return b4a.example.drama.remoteMe.runUserSub(false, "drama","actionpage_click");}
 BA.debugLineNum = 628;BA.debugLine="Private Sub ActionPage_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 629;BA.debugLine="StartActivity(Action)";
Debug.ShouldStop(1048576);
drama.mostCurrent.__c.runVoidMethod ("StartActivity",drama.processBA,(Object)((drama.mostCurrent._action.getObject())));
 BA.debugLineNum = 630;BA.debugLine="Activity.Finish";
...
try {
		Debug.PushSubsStack("Activity_Create (drama) ","drama",2,drama.mostCurrent.activityBA,drama.mostCurrent,107);
...
Debug.ShouldStop(1024);
 BA.debugLineNum = 108;BA.debugLine="Activity.LoadLayout(\"Drama\") ' Layout contains Sc";
...
drama.mostCurrent._p.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("panelview")),drama.mostCurrent.activityBA);
 BA.debugLineNum = 116;BA.debugLine="DramaImage1.Bitmap = LoadBitmap(File.DirAssets, \"";
Debug.ShouldStop(524288);
drama.mostCurrent._dramaimage1.runMethod(false,"setBitmap",(drama.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(drama.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("avengers.jpeg"))).getObject()));
 BA.debugLineNum = 118;BA.debugLine="Drama1.Text = \"Kramer vs. Kramer\"";
Debug.ShouldStop(2097152);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Kramer vs. Kramer"));
 BA.debugLineNum = 119;BA.debugLine="Starter1.Text = \"Starring: Dustin Hoffman, Meryl";
Debug.ShouldStop(4194304);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Dustin Hoffman, Meryl Streep, Justin Henry"));
 BA.debugLineNum = 120;BA.debugLine="Year1.Text = \"(1979)\"";
Debug.ShouldStop(8388608);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(1979)"));
 BA.debugLineNum = 121;BA.debugLine="OverView1.Text = \"In this emotionally charged cou";
...
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("In this emotionally charged courtroom and family drama, Kramer vs. Kramer refers to the heartbreaking custody battle between Ted Kramer, a man forced into single fatherhood, and Joanna Kramer, the wife who returns after abandoning their son. As love, responsibility, and personal growth collide, the film asks: what defines a good parent?"));
 BA.debugLineNum = 123;BA.debugLine="Drama2.Text = \"Manchester by the Sea\"";
Debug.ShouldStop(67108864);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("Manchester by the Sea"));
 BA.debugLineNum = 124;BA.debugLine="Starter2.Text = \"Starring: Casey Affleck, Michell";
...
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Williams, Lucas Hedges"));
 BA.debugLineNum = 125;BA.debugLine="Year2.Text = \"(2016)\"";
Debug.ShouldStop(268435456);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2016)"));
 BA.debugLineNum = 126;BA.debugLine="OverView2.Text = \"After the death of his brother,";
...
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("After the death of his brother, a withdrawn and guilt-ridden janitor is forced to return to his hometown and take care of his teenage nephew. As buried trauma resurfaces, he must face his tragic past and confront the limits of personal healing."));
 BA.debugLineNum = 128;BA.debugLine="Drama6.Text = \"Gone Baby Gone\"";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._drama6.runMethod(true,"setText",BA.ObjectToCharSequence("Gone Baby Gone"));
 BA.debugLineNum = 129;BA.debugLine="Starter6.Text = \"Starring: Casey Affleck, Michell";
Debug.ShouldStop(1);
drama.mostCurrent._starter6.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Monaghan, Morgan Freeman"));
 BA.debugLineNum = 130;BA.debugLine="Year6.Text = \"(2007)\"";
Debug.ShouldStop(2);
drama.mostCurrent._year6.runMethod(true,"setText",BA.ObjectToCharSequence("(2007)"));
 BA.debugLineNum = 131;BA.debugLine="OverView6.Text = \"In a tough Boston neighborhood,";
Debug.ShouldStop(4);
drama.mostCurrent._overview6.runMethod(true,"setText",BA.ObjectToCharSequence("In a tough Boston neighborhood, a pair of private detectives investigates the kidnapping of a young girl. As they get closer to the truth, they are forced to question what justice really means, and whether doing the right thing is always right."));
 BA.debugLineNum = 133;BA.debugLine="Drama4.Text = \"Million Dollar Baby\"";
Debug.ShouldStop(16);
drama.mostCurrent._drama4.runMethod(true,"setText",BA.ObjectToCharSequence("Million Dollar Baby"));
 BA.debugLineNum = 134;BA.debugLine="Starter4.Text = \"Starring: Morgan Freeman, Hilary";
Debug.ShouldStop(32);
drama.mostCurrent._starter4.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Morgan Freeman, Hilary Swank, Clint Eastwood"));
 BA.debugLineNum = 135;BA.debugLine="Year4.Text = \"(2004)\"";
Debug.ShouldStop(64);
drama.mostCurrent._year4.runMethod(true,"setText",BA.ObjectToCharSequence("(2004)"));
 BA.debugLineNum = 136;BA.debugLine="OverView4.Text = \"A waitress with dreams of becom";
...
drama.mostCurrent._overview5.runMethod(true,"setText",BA.ObjectToCharSequence("A brief, passionate romance between a lonely housewife and a traveling photographer leads to a life-changing emotional journey. Set against the backdrop of 1960s Iowa, it’s a heartbreaking story about missed chances and enduring love."));
 BA.debugLineNum = 143;BA.debugLine="Drama3.Text = \"The Master\"";
Debug.ShouldStop(16384);
drama.mostCurrent._drama3.runMethod(true,"setText",BA.ObjectToCharSequence("The Master"));
 BA.debugLineNum = 144;BA.debugLine="Starter3.Text = \"Starring: Philip Seymour Hoffman";
...
drama.mostCurrent._starter3.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Philip Seymour Hoffman, Joaquin Phoenix, Amy Adams"));
 BA.debugLineNum = 145;BA.debugLine="Year3.Text = \"(2012)\"";
Debug.ShouldStop(65536);
drama.mostCurrent._year3.runMethod(true,"setText",BA.ObjectToCharSequence("(2012)"));
 BA.debugLineNum = 146;BA.debugLine="OverView3.Text = \"A mentally unstable WWII vetera";
...
drama.mostCurrent._overview3.runMethod(true,"setText",BA.ObjectToCharSequence("A mentally unstable WWII veteran is drawn to a charismatic cult leader and his belief system. As their relationship grows, the film explores themes of control, identity, and the search for meaning in a post-war world."));
 BA.debugLineNum = 148;BA.debugLine="Drama7.Text = \"Blue Jasmine\"";
Debug.ShouldStop(524288);
drama.mostCurrent._drama7.runMethod(true,"setText",BA.ObjectToCharSequence("Blue Jasmine"));
 BA.debugLineNum = 149;BA.debugLine="Starter7.Text = \"Starring: Cate Blanchett, Sally";
Debug.ShouldStop(1048576);
drama.mostCurrent._starter7.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Cate Blanchett, Sally Hawkins, Alec Baldwin"));
 BA.debugLineNum = 150;BA.debugLine="Year7.Text = \"(2013)\"";
Debug.ShouldStop(2097152);
drama.mostCurrent._year7.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 151;BA.debugLine="OverView7.Text = \"After losing her fortune and st";
Debug.ShouldStop(4194304);
drama.mostCurrent._overview7.runMethod(true,"setText",BA.ObjectToCharSequence("After losing her fortune and status, a New York socialite is forced to move in with her working-class sister. As her mental state deteriorates, her desperate attempts to reclaim her old life unravel into tragic self-destruction."));
 BA.debugLineNum = 153;BA.debugLine="Drama8.Text = \"Her\"";
Debug.ShouldStop(16777216);
drama.mostCurrent._drama8.runMethod(true,"setText",BA.ObjectToCharSequence("Her"));
 BA.debugLineNum = 154;BA.debugLine="Starter8.Text = \"Starring: Joaquin Phoenix, Roone";
...
drama.mostCurrent._starter8.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Joaquin Phoenix, Rooney Mara, Amy Adams"));
 BA.debugLineNum = 155;BA.debugLine="Year8.Text = \"(2013)\"";
Debug.ShouldStop(67108864);
drama.mostCurrent._year8.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 156;BA.debugLine="OverView8.Text = \"In a near-future Los Angeles, a";
Debug.ShouldStop(134217728);
drama.mostCurrent._overview8.runMethod(true,"setText",BA.ObjectToCharSequence("In a near-future Los Angeles, a lonely man finds solace in a hyper-intelligent AI voice. As their bond deepens into love, he’s forced to question what it means to be human and whether artificial connection is real connection."));
 BA.debugLineNum = 158;BA.debugLine="Drama9.Text = \"Carol\"";
Debug.ShouldStop(536870912);
drama.mostCurrent._drama9.runMethod(true,"setText",BA.ObjectToCharSequence("Carol"));
 BA.debugLineNum = 159;BA.debugLine="Starter9.Text = \"Starring: Rooney Mara, Cate Blan";
...
drama.mostCurrent._starter9.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Rooney Mara, Cate Blanchett, Sarah Paulson"));
 BA.debugLineNum = 160;BA.debugLine="Year9.Text = \"(2015)\"";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._year9.runMethod(true,"setText",BA.ObjectToCharSequence("(2015)"));
 BA.debugLineNum = 161;BA.debugLine="OverView9.Text = \"A chance encounter between a yo";
Debug.ShouldStop(1);
drama.mostCurrent._overview9.runMethod(true,"setText",BA.ObjectToCharSequence("A chance encounter between a young aspiring photographer and a glamorous older woman sparks an unexpected romance. Set in the 1950s, this tale of forbidden love explores identity, societal expectations, and emotional resilience."));
 BA.debugLineNum = 163;BA.debugLine="Drama10.Text = \"The Lost Daughter\"";
Debug.ShouldStop(4);
drama.mostCurrent._drama10.runMethod(true,"setText",BA.ObjectToCharSequence("The Lost Daughter"));
 BA.debugLineNum = 164;BA.debugLine="Starter10.Text = \"Starring: Olivia Colman, Dakota";
Debug.ShouldStop(8);
drama.mostCurrent._starter10.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Olivia Colman, Dakota Johnson, Jessie Buckley"));
 BA.debugLineNum = 165;BA.debugLine="Year10.Text = \"(2021)\"";
Debug.ShouldStop(16);
drama.mostCurrent._year10.runMethod(true,"setText",BA.ObjectToCharSequence("(2021)"));
 BA.debugLineNum = 166;BA.debugLine="OverView10.Text = \"A solitary woman on vacation b";
Debug.ShouldStop(32);
drama.mostCurrent._overview10.runMethod(true,"setText",BA.ObjectToCharSequence("A solitary woman on vacation becomes fascinated by a young mother and her daughter, triggering memories of her own past choices as a parent. The film dives into the complexities of motherhood, regret, and identity"));
 BA.debugLineNum = 168;BA.debugLine="ScrollView1.Panel.AddView(p, 0, 0, 200%x, 210%y)";
Debug.ShouldStop(128);
drama.mostCurrent._scrollview1.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((drama.mostCurrent._p.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(drama.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 200)),drama.mostCurrent.activityBA)),(Object)(drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 210)),drama.mostCurrent.activityBA)));
 BA.debugLineNum = 169;BA.debugLine="ScrollView1.Panel.Height = p.Height";
...
try {
		Debug.PushSubsStack("DramaPage_Click (drama) ","drama",2,drama.mostCurrent.activityBA,drama.mostCurrent,624);
if (RapidSub.canDelegate("dramapage_click")) { return b4a.example.drama.remoteMe.runUserSub(false, "drama","dramapage_click");}
 BA.debugLineNum = 624;BA.debugLine="Private Sub DramaPage_Click";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("HideAllPanels (drama) ","drama",2,drama.mostCurrent.activityBA,drama.mostCurrent,522);
if (RapidSub.canDelegate("hideallpanels")) { return b4a.example.drama.remoteMe.runUserSub(false, "drama","hideallpanels");}
 BA.debugLineNum = 522;BA.debugLine="Private Sub HideAllPanels";
Debug.ShouldStop(512);
 BA.debugLineNum = 523;BA.debugLine="Panel2.Visible = False";
Debug.ShouldStop(1024);
drama.mostCurrent._panel2.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 524;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(2048);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 525;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("HomePage_Click (drama) ","drama",2,drama.mostCurrent.activityBA,drama.mostCurrent,619);
if (RapidSub.canDelegate("homepage_click")) { return b4a.example.drama.remoteMe.runUserSub(false, "drama","homepage_click");}
 BA.debugLineNum = 619;BA.debugLine="Private Sub HomePage_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 620;BA.debugLine="StartActivity(Main)";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("SciFiPage_Click (drama) ","drama",2,drama.mostCurrent.activityBA,drama.mostCurrent,614);
if (RapidSub.canDelegate("scifipage_click")) { return b4a.example.drama.remoteMe.runUserSub(false, "drama","scifipage_click");}
 BA.debugLineNum = 614;BA.debugLine="Private Sub SciFiPage_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 615;BA.debugLine="StartActivity(SciFi)";
Debug.ShouldStop(64);
drama.mostCurrent.__c.runVoidMethod ("StartActivity",drama.processBA,(Object)((drama.mostCurrent._scifi.getObject())));
 BA.debugLineNum = 616;BA.debugLine="Activity.Finish";
Debug.ShouldStop(128);
drama.mostCurrent._activity.runVoidMethod ("Finish");
...
try {
		Debug.PushSubsStack("SearchBtn_Click (drama) ","drama",2,drama.mostCurrent.activityBA,drama.mostCurrent,172);
...
RemoteObject _query = RemoteObject.createImmutable("");
 BA.debugLineNum = 172;BA.debugLine="Private Sub SearchBtn_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 173;BA.debugLine="Dim query As String = SearchEngine.Text.ToLowerCa";
Debug.ShouldStop(4096);
_query = drama.mostCurrent._searchengine.runMethod(true,"getText").runMethod(true,"toLowerCase").runMethod(true,"trim");Debug.locals.put("query", _query);Debug.locals.put("query", _query);
 BA.debugLineNum = 178;BA.debugLine="If query.Contains(\"kramer\") Or query.Contains(\"kr";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("kramer")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("kramer vs kramer"))))) { 
 BA.debugLineNum = 180;BA.debugLine="Drama1.Text = \"Kramer vs. Kramer\"";
Debug.ShouldStop(524288);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Kramer vs. Kramer"));
 BA.debugLineNum = 181;BA.debugLine="Starter1.Text = \"Starring: Dustin Hoffman, Meryl";
Debug.ShouldStop(1048576);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Dustin Hoffman, Meryl Streep, Justin Henry"));
 BA.debugLineNum = 182;BA.debugLine="Year1.Text = \"(1979)\"";
Debug.ShouldStop(2097152);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(1979)"));
 BA.debugLineNum = 183;BA.debugLine="OverView1.Text = \"In this emotionally charged co";
Debug.ShouldStop(4194304);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("In this emotionally charged courtroom and family drama, Kramer vs. Kramer refers to the heartbreaking custody battle between Ted Kramer, a man forced into single fatherhood, and Joanna Kramer, the wife who returns after abandoning their son. As love, responsibility, and personal growth collide, the film asks: what defines a good parent?"));
 BA.debugLineNum = 185;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(16777216);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 186;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(33554432);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 187;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(67108864);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 188;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(134217728);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 189;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(268435456);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 191;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(1073741824);
...
{ BA.debugLineNum = 193;BA.debugLine="Else If query.Contains(\"manchester by the Sea\") O";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("manchester by the Sea")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("manchester"))))) { 
 BA.debugLineNum = 195;BA.debugLine="Drama1.Text = \"Manchester by the Sea\"";
Debug.ShouldStop(4);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Manchester by the Sea"));
 BA.debugLineNum = 196;BA.debugLine="Starter1.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(8);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Williams, Lucas Hedges"));
 BA.debugLineNum = 197;BA.debugLine="Year1.Text = \"(2016)\"";
Debug.ShouldStop(16);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2016)"));
 BA.debugLineNum = 198;BA.debugLine="OverView1.Text = \"After the death of his brother";
Debug.ShouldStop(32);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("After the death of his brother, a withdrawn and guilt-ridden janitor is forced to return to his hometown and take care of his teenage nephew. As buried trauma resurfaces, he must face his tragic past and confront the limits of personal healing."));
 BA.debugLineNum = 200;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(128);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 201;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(256);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 202;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(512);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 203;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(1024);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 204;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(2048);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 206;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(8192);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 208;BA.debugLine="Else If query.Contains(\"the master\") Or query.Con";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("the master")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("master"))))) { 
 BA.debugLineNum = 210;BA.debugLine="Drama1.Text = \"The Master\"";
Debug.ShouldStop(131072);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("The Master"));
 BA.debugLineNum = 211;BA.debugLine="Starter1.Text = \"Starring: Philip Seymour Hoffma";
Debug.ShouldStop(262144);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Philip Seymour Hoffman, Joaquin Phoenix, Amy Adams"));
 BA.debugLineNum = 212;BA.debugLine="Year1.Text = \"(2012)\"";
Debug.ShouldStop(524288);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2012)"));
 BA.debugLineNum = 213;BA.debugLine="OverView1.Text = \"A mentally unstable WWII veter";
Debug.ShouldStop(1048576);
...
{ BA.debugLineNum = 223;BA.debugLine="Else If query.Contains(\"million dollar\") Or query";
Debug.ShouldStop(1073741824);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("million dollar")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("million")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("million dollar baby"))))) { 
 BA.debugLineNum = 225;BA.debugLine="Drama1.Text = \"Million Dollar Baby\"";
Debug.ShouldStop(1);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Million Dollar Baby"));
 BA.debugLineNum = 226;BA.debugLine="Starter1.Text = \"Starring: Morgan Freeman, Hilar";
Debug.ShouldStop(2);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Morgan Freeman, Hilary Swank, Clint Eastwood"));
 BA.debugLineNum = 227;BA.debugLine="Year1.Text = \"(2004)\"";
Debug.ShouldStop(4);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2004)"));
 BA.debugLineNum = 228;BA.debugLine="OverView1.Text = \"A waitress with dreams of beco";
Debug.ShouldStop(8);
...
{ BA.debugLineNum = 239;BA.debugLine="Else If query.Contains(\"the Bridges of madison co";
Debug.ShouldStop(16384);
...
{ BA.debugLineNum = 254;BA.debugLine="Else If query.Contains(\"gone\") Or query.Contains(";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("gone")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("gone baby gone")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("gone baby"))))) { 
 BA.debugLineNum = 256;BA.debugLine="Drama1.Text = \"Gone Baby Gone\"";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Gone Baby Gone"));
 BA.debugLineNum = 257;BA.debugLine="Starter1.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(1);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Monaghan, Morgan Freeman"));
 BA.debugLineNum = 258;BA.debugLine="Year1.Text = \"(2007)\"";
Debug.ShouldStop(2);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2007)"));
 BA.debugLineNum = 259;BA.debugLine="OverView1.Text = \"In a tough Boston neighborhood";
Debug.ShouldStop(4);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("In a tough Boston neighborhood, a pair of private detectives investigates the kidnapping of a young girl. As they get closer to the truth, they are forced to question what justice really means, and whether doing the right thing is always right."));
 BA.debugLineNum = 261;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(16);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 262;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(32);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 263;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(64);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 264;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(128);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 265;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(256);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 267;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(1024);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 269;BA.debugLine="Else If query.Contains(\"blue\") Or query.Contains(";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("blue")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("blue jasmine"))))) { 
 BA.debugLineNum = 272;BA.debugLine="Drama1.Text = \"Blue Jasmine\"";
Debug.ShouldStop(32768);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Blue Jasmine"));
 BA.debugLineNum = 273;BA.debugLine="Starter1.Text = \"Starring: Cate Blanchett, Sally";
Debug.ShouldStop(65536);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Cate Blanchett, Sally Hawkins, Alec Baldwin"));
 BA.debugLineNum = 274;BA.debugLine="Year1.Text = \"(2013)\"";
Debug.ShouldStop(131072);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 275;BA.debugLine="OverView1.Text = \"After losing her fortune and s";
Debug.ShouldStop(262144);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("After losing her fortune and status, a New York socialite is forced to move in with her working-class sister. As her mental state deteriorates, her desperate attempts to reclaim her old life unravel into tragic self-destruction."));
 BA.debugLineNum = 277;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(1048576);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 278;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(2097152);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 279;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(4194304);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 280;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(8388608);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 281;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(16777216);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 283;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(67108864);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 285;BA.debugLine="Else If query.Contains(\"her\") Then";
Debug.ShouldStop(268435456);
if (_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("her"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 287;BA.debugLine="Drama1.Text = \"Her\"";
Debug.ShouldStop(1073741824);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Her"));
 BA.debugLineNum = 288;BA.debugLine="Starter1.Text = \"Starring: Joaquin Phoenix, Roon";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Joaquin Phoenix, Rooney Mara, Amy Adams"));
 BA.debugLineNum = 289;BA.debugLine="Year1.Text = \"(2013)\"";
Debug.ShouldStop(1);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 290;BA.debugLine="OverView1.Text = \"In a near-future Los Angeles,";
Debug.ShouldStop(2);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("In a near-future Los Angeles, a lonely man finds solace in a hyper-intelligent AI voice. As their bond deepens into love, he’s forced to question what it means to be human and whether artificial connection is real connection."));
 BA.debugLineNum = 292;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(8);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 293;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(16);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 294;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(32);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 295;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(64);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 296;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(128);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 298;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(512);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 300;BA.debugLine="Else If query.Contains(\"carol\") Or query.Contains";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("carol")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("sarah paulson")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("sarah")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("paulson"))))) { 
 BA.debugLineNum = 302;BA.debugLine="Drama1.Text = \"Carol\"";
Debug.ShouldStop(8192);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Carol"));
 BA.debugLineNum = 303;BA.debugLine="Starter1.Text = \"Starring: Rooney Mara, Cate Bla";
Debug.ShouldStop(16384);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Rooney Mara, Cate Blanchett, Sarah Paulson"));
 BA.debugLineNum = 304;BA.debugLine="Year1.Text = \"(2015)\"";
Debug.ShouldStop(32768);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2015)"));
 BA.debugLineNum = 305;BA.debugLine="OverView1.Text = \"A chance encounter between a y";
Debug.ShouldStop(65536);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A chance encounter between a young aspiring photographer and a glamorous older woman sparks an unexpected romance. Set in the 1950s, this tale of forbidden love explores identity, societal expectations, and emotional resilience."));
 BA.debugLineNum = 307;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(262144);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 308;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(524288);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 309;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(1048576);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 310;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(2097152);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 311;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(4194304);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 313;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(16777216);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 315;BA.debugLine="Else If query.Contains(\"the lost daugther\") Or qu";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("the lost daugther")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("lost daughter")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("lost"))))) { 
 BA.debugLineNum = 317;BA.debugLine="Drama1.Text = \"The Lost Daughter\"";
Debug.ShouldStop(268435456);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("The Lost Daughter"));
 BA.debugLineNum = 318;BA.debugLine="Starter1.Text = \"Starring: Olivia Colman, Dakota";
Debug.ShouldStop(536870912);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Olivia Colman, Dakota Johnson, Jessie Buckley"));
 BA.debugLineNum = 319;BA.debugLine="Year1.Text = \"(2021)\"";
Debug.ShouldStop(1073741824);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2021)"));
 BA.debugLineNum = 320;BA.debugLine="OverView1.Text = \"A solitary woman on vacation b";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A solitary woman on vacation becomes fascinated by a young mother and her daughter, triggering memories of her own past choices as a parent. The film dives into the complexities of motherhood, regret, and identity"));
 BA.debugLineNum = 322;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(2);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 323;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(4);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 324;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(8);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 325;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(16);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 326;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(32);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 328;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(128);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 330;BA.debugLine="Else If query.Contains(\"meryl streep\") Or query.C";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("meryl streep")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("meryl")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("streep"))))) { 
 BA.debugLineNum = 331;BA.debugLine="Drama1.Text = \"The Bridges of Madison County\"";
Debug.ShouldStop(1024);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("The Bridges of Madison County"));
 BA.debugLineNum = 332;BA.debugLine="Starter1.Text = \"Starring: Clint Eastwood, Meryl";
Debug.ShouldStop(2048);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Clint Eastwood, Meryl Streep"));
 BA.debugLineNum = 333;BA.debugLine="Year1.Text = \"(1995)\"";
Debug.ShouldStop(4096);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(1995)"));
 BA.debugLineNum = 334;BA.debugLine="OverView1.Text = \"A brief, passionate romance be";
Debug.ShouldStop(8192);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A brief, passionate romance between a lonely housewife and a traveling photographer leads to a life-changing emotional journey. Set against the backdrop of 1960s Iowa, it’s a heartbreaking story about missed chances and enduring love."));
 BA.debugLineNum = 336;BA.debugLine="Drama2.Text = \"Doubt\"";
Debug.ShouldStop(32768);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("Doubt"));
 BA.debugLineNum = 337;BA.debugLine="Starter2.Text = \"Starring: Meryl Streep, Philip";
Debug.ShouldStop(65536);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Meryl Streep, Philip Seymour Hoffman, Amy Adams"));
 BA.debugLineNum = 338;BA.debugLine="Year2.Text = \"(2008)\"";
Debug.ShouldStop(131072);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2008)"));
 BA.debugLineNum = 339;BA.debugLine="OverView2.Text = \"In a Catholic school in the Br";
Debug.ShouldStop(262144);
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("In a Catholic school in the Bronx, a strict nun becomes suspicious of a priest’s relationship with a student. As she digs deeper, the lines between truth and suspicion blur, leaving everyone in moral and emotional limbo."));
 BA.debugLineNum = 341;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(1048576);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 342;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(2097152);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 343;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(4194304);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 344;BA.debugLine="p.Height = 85%y";
Debug.ShouldStop(8388608);
...
{ BA.debugLineNum = 345;BA.debugLine="Else If query.Contains(\"casey\") Or query.Contains";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("casey")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("casey affleck"))))) { 
 BA.debugLineNum = 346;BA.debugLine="Drama1.Text = \"Gone Baby Gone\"";
Debug.ShouldStop(33554432);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Gone Baby Gone"));
 BA.debugLineNum = 347;BA.debugLine="Starter1.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(67108864);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Monaghan, Morgan Freeman"));
 BA.debugLineNum = 348;BA.debugLine="Year1.Text = \"(2007)\"";
Debug.ShouldStop(134217728);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2007)"));
 BA.debugLineNum = 349;BA.debugLine="OverView1.Text = \"In a tough Boston neighborhood";
Debug.ShouldStop(268435456);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("In a tough Boston neighborhood, a pair of private detectives investigates the kidnapping of a young girl. As they get closer to the truth, they are forced to question what justice really means, and whether doing the right thing is always right."));
 BA.debugLineNum = 351;BA.debugLine="Drama2.Text = \"Manchester by the Sea\"";
Debug.ShouldStop(1073741824);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("Manchester by the Sea"));
 BA.debugLineNum = 352;BA.debugLine="Starter2.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Williams, Lucas Hedges"));
 BA.debugLineNum = 353;BA.debugLine="Year2.Text = \"(2016)\"";
Debug.ShouldStop(1);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2016)"));
 BA.debugLineNum = 354;BA.debugLine="OverView2.Text = \"After the death of his brother";
Debug.ShouldStop(2);
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("After the death of his brother, a withdrawn and guilt-ridden janitor is forced to return to his hometown and take care of his teenage nephew. As buried trauma resurfaces, he must face his tragic past and confront the limits of personal healing."));
 BA.debugLineNum = 356;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(8);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 357;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(16);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 358;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(32);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 359;BA.debugLine="p.Height = 85%y";
Debug.ShouldStop(64);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 85)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 361;BA.debugLine="Else If query.Contains(\"joaquin\") Or query.Contai";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("joaquin")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("joaquin phoenix")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("amy adams")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("amy"))))) { 
 BA.debugLineNum = 362;BA.debugLine="Drama1.Text = \"The Master\"";
Debug.ShouldStop(512);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("The Master"));
 BA.debugLineNum = 363;BA.debugLine="Starter1.Text = \"Starring: Philip Seymour Hoffma";
Debug.ShouldStop(1024);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Philip Seymour Hoffman, Joaquin Phoenix, Amy Adams"));
 BA.debugLineNum = 364;BA.debugLine="Year1.Text = \"(2012)\"";
Debug.ShouldStop(2048);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2012)"));
 BA.debugLineNum = 365;BA.debugLine="OverView1.Text = \"A mentally unstable WWII veter";
Debug.ShouldStop(4096);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A mentally unstable WWII veteran is drawn to a charismatic cult leader and his belief system. As their relationship grows, the film explores themes of control, identity, and the search for meaning in a post-war world."));
 BA.debugLineNum = 367;BA.debugLine="Drama2.Text = \"Her\"";
Debug.ShouldStop(16384);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("Her"));
 BA.debugLineNum = 368;BA.debugLine="Starter2.Text = \"Starring: Joaquin Phoenix, Roon";
Debug.ShouldStop(32768);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Joaquin Phoenix, Rooney Mara, Amy Adams"));
 BA.debugLineNum = 369;BA.debugLine="Year2.Text = \"(2013)\"";
Debug.ShouldStop(65536);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 370;BA.debugLine="OverView2.Text = \"In a near-future Los Angeles,";
Debug.ShouldStop(131072);
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("In a near-future Los Angeles, a lonely man finds solace in a hyper-intelligent AI voice. As their bond deepens into love, he’s forced to question what it means to be human and whether artificial connection is real connection."));
 BA.debugLineNum = 372;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(524288);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 373;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(1048576);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 374;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(2097152);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 375;BA.debugLine="p.Height = 85%y";
Debug.ShouldStop(4194304);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 85)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 377;BA.debugLine="Else If query.Contains(\"cate blanchett\") Or query";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("cate blanchett")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("cate"))))) { 
 BA.debugLineNum = 378;BA.debugLine="Drama1.Text = \"Carol\"";
Debug.ShouldStop(33554432);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Carol"));
 BA.debugLineNum = 379;BA.debugLine="Starter1.Text = \"Starring: Rooney Mara, Cate Bla";
Debug.ShouldStop(67108864);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Rooney Mara, Cate Blanchett, Sarah Paulson"));
 BA.debugLineNum = 380;BA.debugLine="Year1.Text = \"(2015)\"";
Debug.ShouldStop(134217728);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2015)"));
 BA.debugLineNum = 381;BA.debugLine="OverView1.Text = \"A chance encounter between a y";
Debug.ShouldStop(268435456);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A chance encounter between a young aspiring photographer and a glamorous older woman sparks an unexpected romance. Set in the 1950s, this tale of forbidden love explores identity, societal expectations, and emotional resilience."));
 BA.debugLineNum = 383;BA.debugLine="Drama2.Text = \"Blue Jasmine\"";
Debug.ShouldStop(1073741824);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("Blue Jasmine"));
 BA.debugLineNum = 384;BA.debugLine="Starter2.Text = \"Starring: Cate Blanchett, Sally";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Cate Blanchett, Sally Hawkins, Alec Baldwin"));
 BA.debugLineNum = 385;BA.debugLine="Year2.Text = \"(2013)\"";
Debug.ShouldStop(1);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 386;BA.debugLine="OverView2.Text = \"After losing her fortune and s";
Debug.ShouldStop(2);
...
Debug.ShouldStop(32);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 391;BA.debugLine="p.Height = 85%y";
Debug.ShouldStop(64);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 85)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 392;BA.debugLine="Else If query.Contains(\"morgan freeman\") Or query";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("morgan freeman")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("morgan"))))) { 
 BA.debugLineNum = 393;BA.debugLine="Drama1.Text = \"Million Dollar Baby\"";
Debug.ShouldStop(256);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Million Dollar Baby"));
 BA.debugLineNum = 394;BA.debugLine="Starter1.Text = \"Starring: Morgan Freeman, Hilar";
Debug.ShouldStop(512);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Morgan Freeman, Hilary Swank, Clint Eastwood"));
 BA.debugLineNum = 395;BA.debugLine="Year1.Text = \"(2004)\"";
Debug.ShouldStop(1024);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2004)"));
 BA.debugLineNum = 396;BA.debugLine="OverView1.Text = \"A waitress with dreams of beco";
Debug.ShouldStop(2048);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A waitress with dreams of becoming a boxer convinces a reluctant trainer to take her on. As she rises through the ranks, a tragic turn of events forces them both to reckon with loss, dignity, and the nature of love."));
 BA.debugLineNum = 398;BA.debugLine="Drama2.Text = \"Gone Baby Gone\"";
Debug.ShouldStop(8192);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("Gone Baby Gone"));
 BA.debugLineNum = 399;BA.debugLine="Starter2.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(16384);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Monaghan, Morgan Freeman"));
 BA.debugLineNum = 400;BA.debugLine="Year2.Text = \"(2007)\"";
Debug.ShouldStop(32768);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2007)"));
 BA.debugLineNum = 401;BA.debugLine="OverView2.Text = \"In a tough Boston neighborhood";
Debug.ShouldStop(65536);
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("In a tough Boston neighborhood, a pair of private detectives investigates the kidnapping of a young girl. As they get closer to the truth, they are forced to question what justice really means, and whether doing the right thing is always right."));
 BA.debugLineNum = 403;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(262144);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 404;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(524288);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 405;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(1048576);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 406;BA.debugLine="p.Height = 85%y";
Debug.ShouldStop(2097152);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 85)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 407;BA.debugLine="Else If query.Contains(\"clint eastwood\") Or query";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("clint eastwood")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("clint")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("eastwood"))))) { 
 BA.debugLineNum = 408;BA.debugLine="Drama1.Text = \"Million Dollar Baby\"";
Debug.ShouldStop(8388608);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Million Dollar Baby"));
 BA.debugLineNum = 409;BA.debugLine="Starter1.Text = \"Starring: Morgan Freeman, Hilar";
Debug.ShouldStop(16777216);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Morgan Freeman, Hilary Swank, Clint Eastwood"));
 BA.debugLineNum = 410;BA.debugLine="Year1.Text = \"(2004)\"";
Debug.ShouldStop(33554432);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2004)"));
 BA.debugLineNum = 411;BA.debugLine="OverView1.Text = \"A waitress with dreams of beco";
Debug.ShouldStop(67108864);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A waitress with dreams of becoming a boxer convinces a reluctant trainer to take her on. As she rises through the ranks, a tragic turn of events forces them both to reckon with loss, dignity, and the nature of love."));
 BA.debugLineNum = 413;BA.debugLine="Drama2.Text = \"The Bridges of Madison Country\"";
Debug.ShouldStop(268435456);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("The Bridges of Madison Country"));
 BA.debugLineNum = 414;BA.debugLine="Starter2.Text = \"Starring: Clint Eastwood, Meryl";
Debug.ShouldStop(536870912);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Clint Eastwood, Meryl Streep"));
 BA.debugLineNum = 415;BA.debugLine="Year2.Text = \"(1995)\"";
Debug.ShouldStop(1073741824);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(1995)"));
 BA.debugLineNum = 416;BA.debugLine="OverView2.Text = \"A brief, passionate romance be";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("A brief, passionate romance between a lonely housewife and a traveling photographer leads to a life-changing emotional journey. Set against the backdrop of 1960s Iowa, it’s a heartbreaking story about missed chances and enduring love."));
 BA.debugLineNum = 418;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(2);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 419;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(4);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 420;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(8);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
...
{ BA.debugLineNum = 422;BA.debugLine="Else If query.Contains(\"amy Adams\") Or query.Cont";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("amy Adams")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("amy")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("adams"))))) { 
 BA.debugLineNum = 423;BA.debugLine="Drama1.Text = \"Doubt\"";
Debug.ShouldStop(64);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Doubt"));
 BA.debugLineNum = 424;BA.debugLine="Starter1.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(128);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Monaghan, Morgan Freeman"));
 BA.debugLineNum = 425;BA.debugLine="Year1.Text = \"(2008)\"";
Debug.ShouldStop(256);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2008)"));
 BA.debugLineNum = 426;BA.debugLine="OverView1.Text = \"In a Catholic school in the Br";
Debug.ShouldStop(512);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("In a Catholic school in the Bronx, a strict nun becomes suspicious of a priest’s relationship with a student. As she digs deeper, the lines between truth and suspicion blur, leaving everyone in moral and emotional limbo."));
 BA.debugLineNum = 428;BA.debugLine="Drama2.Text = \"The Master\"";
Debug.ShouldStop(2048);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("The Master"));
 BA.debugLineNum = 429;BA.debugLine="Starter2.Text = \"Starring: Philip Seymour Hoffma";
Debug.ShouldStop(4096);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Philip Seymour Hoffman, Joaquin Phoenix, Amy Adams"));
 BA.debugLineNum = 430;BA.debugLine="Year2.Text = \"(2012)\"";
Debug.ShouldStop(8192);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2012)"));
 BA.debugLineNum = 431;BA.debugLine="OverView2.Text = \"A mentally unstable WWII veter";
Debug.ShouldStop(16384);
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("A mentally unstable WWII veteran is drawn to a charismatic cult leader and his belief system. As their relationship grows, the film explores themes of control, identity, and the search for meaning in a post-war world."));
 BA.debugLineNum = 433;BA.debugLine="Drama3.Text = \"Her\"";
Debug.ShouldStop(65536);
drama.mostCurrent._drama3.runMethod(true,"setText",BA.ObjectToCharSequence("Her"));
 BA.debugLineNum = 434;BA.debugLine="Starter3.Text = \"Starring: Joaquin Phoenix, Roon";
Debug.ShouldStop(131072);
drama.mostCurrent._starter3.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Joaquin Phoenix, Rooney Mara, Amy Adams"));
 BA.debugLineNum = 435;BA.debugLine="Year3.Text = \"(2013)\"";
Debug.ShouldStop(262144);
drama.mostCurrent._year3.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 436;BA.debugLine="OverView3.Text = \"In a near-future Los Angeles,";
Debug.ShouldStop(524288);
drama.mostCurrent._overview3.runMethod(true,"setText",BA.ObjectToCharSequence("In a near-future Los Angeles, a lonely man finds solace in a hyper-intelligent AI voice. As their bond deepens into love, he’s forced to question what it means to be human and whether artificial connection is real connection."));
 BA.debugLineNum = 438;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(2097152);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 439;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(4194304);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 440;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(8388608);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 441;BA.debugLine="p.Height = 85%y";
Debug.ShouldStop(16777216);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 85)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 442;BA.debugLine="Else If query.Contains(\"rooney mara\") Or query.Co";
Debug.ShouldStop(33554432);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("rooney mara")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("rooney")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("mara")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("sarah")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("sarah paulson")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("paulson"))))) { 
 BA.debugLineNum = 443;BA.debugLine="Drama1.Text = \"Carol\"";
Debug.ShouldStop(67108864);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Carol"));
 BA.debugLineNum = 444;BA.debugLine="Starter1.Text = \"Starring: Rooney Mara, Cate Bla";
Debug.ShouldStop(134217728);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Rooney Mara, Cate Blanchett, Sarah Paulson"));
 BA.debugLineNum = 445;BA.debugLine="Year1.Text = \"(2015)\"";
Debug.ShouldStop(268435456);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2015)"));
 BA.debugLineNum = 446;BA.debugLine="OverView1.Text = \"A chance encounter between a y";
Debug.ShouldStop(536870912);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A chance encounter between a young aspiring photographer and a glamorous older woman sparks an unexpected romance. Set in the 1950s, this tale of forbidden love explores identity, societal expectations, and emotional resilience."));
 BA.debugLineNum = 448;BA.debugLine="Drama2.Text = \"Blue Jasmine\"";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("Blue Jasmine"));
 BA.debugLineNum = 449;BA.debugLine="Starter2.Text = \"Starring: Cate Blanchett, Sally";
Debug.ShouldStop(1);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Cate Blanchett, Sally Hawkins, Alec Baldwin"));
 BA.debugLineNum = 450;BA.debugLine="Year2.Text = \"(2013)\"";
Debug.ShouldStop(2);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 451;BA.debugLine="OverView2.Text = \"After losing her fortune and s";
Debug.ShouldStop(4);
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("After losing her fortune and status, a New York socialite is forced to move in with her working-class sister. As her mental state deteriorates, her desperate attempts to reclaim her old life unravel into tragic self-destruction."));
 BA.debugLineNum = 453;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(16);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 454;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(32);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 455;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(64);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 456;BA.debugLine="p.Height = 85%y";
Debug.ShouldStop(128);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 85)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 458;BA.debugLine="Else If query.Contains(\"olvia coloman\") Or query.";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("olvia coloman")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("dakota johnson")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("jessie buckley")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("olvia")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("jessie ")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("dakota")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("buckley")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("coloman")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("johnson"))))) { 
 BA.debugLineNum = 459;BA.debugLine="Drama1.Text = \"Carol\"";
Debug.ShouldStop(1024);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Carol"));
 BA.debugLineNum = 460;BA.debugLine="Starter1.Text = \"Starring: Rooney Mara, Cate Bla";
Debug.ShouldStop(2048);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Rooney Mara, Cate Blanchett, Sarah Paulson"));
 BA.debugLineNum = 461;BA.debugLine="Year1.Text = \"(2015)\"";
Debug.ShouldStop(4096);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2015)"));
 BA.debugLineNum = 462;BA.debugLine="OverView1.Text = \"A solitary woman on vacation b";
Debug.ShouldStop(8192);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("A solitary woman on vacation becomes fascinated by a young mother and her daughter, triggering memories of her own past choices as a parent. The film dives into the complexities of motherhood, regret, and identity."));
 BA.debugLineNum = 464;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(32768);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 465;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(65536);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 466;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(131072);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 467;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(262144);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 468;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(524288);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 470;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(2097152);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 471;BA.debugLine="Else If query.Contains(\"sally hawkins\") Or query.";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("sally hawkins")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("alec baldwin")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("sally")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("haswkins")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("alec")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("baldwin"))))) { 
 BA.debugLineNum = 472;BA.debugLine="Drama1.Text = \"Blue Jasmine\"";
Debug.ShouldStop(8388608);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Blue Jasmine"));
 BA.debugLineNum = 473;BA.debugLine="Starter1.Text = \"Starring: Cate Blanchett, Sally";
Debug.ShouldStop(16777216);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Cate Blanchett, Sally Hawkins, Alec Baldwin"));
 BA.debugLineNum = 474;BA.debugLine="Year1.Text = \"(2013)\"";
Debug.ShouldStop(33554432);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 475;BA.debugLine="OverView1.Text = \"After losing her fortune and s";
Debug.ShouldStop(67108864);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("After losing her fortune and status, a New York socialite is forced to move in with her working-class sister. As her mental state deteriorates, her desperate attempts to reclaim her old life unravel into tragic self-destruction."));
 BA.debugLineNum = 477;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(268435456);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 478;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(536870912);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 479;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(1073741824);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 480;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 481;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(1);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 483;BA.debugLine="p.Height = 70%y";
Debug.ShouldStop(4);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 }else 
{ BA.debugLineNum = 484;BA.debugLine="Else if query.Contains(\"michelle williams\") Or qu";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("michelle williams")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("lucas hedges")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("michelle")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("williams")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("lucas")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("hedges"))))) { 
 BA.debugLineNum = 485;BA.debugLine="Drama1.Text = \"Manchester by the Sea\"";
Debug.ShouldStop(16);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Manchester by the Sea"));
 BA.debugLineNum = 486;BA.debugLine="Starter1.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(32);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Williams, Lucas Hedges"));
 BA.debugLineNum = 487;BA.debugLine="Year1.Text = \"(2016)\"";
Debug.ShouldStop(64);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(2016)"));
 BA.debugLineNum = 488;BA.debugLine="OverView1.Text = \"After the death of his brother";
Debug.ShouldStop(128);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("After the death of his brother, a withdrawn and guilt-ridden janitor is forced to return to his hometown and take care of his teenage nephew. As buried trauma resurfaces, he must face his tragic past and confront the limits of personal healing."));
 BA.debugLineNum = 490;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(512);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 491;BA.debugLine="Panel4.Visible = False";
Debug.ShouldStop(1024);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 492;BA.debugLine="Panel5.Visible = False";
Debug.ShouldStop(2048);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 493;BA.debugLine="Panel6.Visible = False";
Debug.ShouldStop(4096);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 494;BA.debugLine="Panel7.Visible = False";
Debug.ShouldStop(8192);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"False"));
...
{ BA.debugLineNum = 497;BA.debugLine="Else if query.Contains(\"dustin hoffman\") Or query";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("dustin hoffman")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("dustin")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("hoffman")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("justin henry")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("justin")))) || RemoteObject.solveBoolean(".",_query.runMethod(true,"contains",(Object)(RemoteObject.createImmutable("henry"))))) { 
 BA.debugLineNum = 498;BA.debugLine="Drama1.Text = \"Kramer vs. Kramer\"";
Debug.ShouldStop(131072);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Kramer vs. Kramer"));
 BA.debugLineNum = 499;BA.debugLine="Starter1.Text = \"Starring: Dustin Hoffman, Meryl";
Debug.ShouldStop(262144);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Dustin Hoffman, Meryl Streep, Justin Henry"));
 BA.debugLineNum = 500;BA.debugLine="Year1.Text = \"(1979)\"";
Debug.ShouldStop(524288);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(1979)"));
 BA.debugLineNum = 501;BA.debugLine="OverView1.Text = \"In this emotionally charged co";
Debug.ShouldStop(1048576);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("In this emotionally charged courtroom and family drama, Kramer vs. Kramer refers to the heartbreaking custody battle between Ted Kramer, a man forced into single fatherhood, and Joanna Kramer, the wife who returns after abandoning their son. As love, responsibility, and personal growth collide, the film asks: what defines a good parent?"));
...
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 70)),drama.mostCurrent.activityBA));
 ...
 BA.debugLineNum = 511;BA.debugLine="HideAllPanels";
Debug.ShouldStop(1073741824);
_hideallpanels();
 BA.debugLineNum = 513;BA.debugLine="NotFound.Text = \"Not Found!\"";
Debug.ShouldStop(1);
drama.mostCurrent._notfound.runMethod(true,"setText",BA.ObjectToCharSequence("Not Found!"));
 }}}}}}}}}}}}}}}}}}}}}}
;
 BA.debugLineNum = 518;BA.debugLine="p.Width = 100%x";
Debug.ShouldStop(32);
drama.mostCurrent._p.runMethod(true,"setWidth",drama.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 100)),drama.mostCurrent.activityBA));
 BA.debugLineNum = 519;BA.debugLine="ScrollView1.Panel.Height = p.Height";
Debug.ShouldStop(64);
drama.mostCurrent._scrollview1.runMethod(false,"getPanel").runMethod(true,"setHeight",drama.mostCurrent._p.runMethod(true,"getHeight"));
...
try {
		Debug.PushSubsStack("SearchEngine_TextChanged (drama) ","drama",2,drama.mostCurrent.activityBA,drama.mostCurrent,536);
...
Debug.locals.put("New", _new);
 BA.debugLineNum = 536;BA.debugLine="Sub SearchEngine_TextChanged (Old As String, New A";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 537;BA.debugLine="Dim query As String = New.ToLowerCase.Trim";
Debug.ShouldStop(16777216);
_query = _new.runMethod(true,"toLowerCase").runMethod(true,"trim");Debug.locals.put("query", _query);Debug.locals.put("query", _query);
 BA.debugLineNum = 539;BA.debugLine="If query = \"\" Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",_query,BA.ObjectToString(""))) { 
 BA.debugLineNum = 541;BA.debugLine="NotFound.Text = \"\"";
Debug.ShouldStop(268435456);
drama.mostCurrent._notfound.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 542;BA.debugLine="p.Height = 210%y";
Debug.ShouldStop(536870912);
drama.mostCurrent._p.runMethod(true,"setHeight",drama.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 210)),drama.mostCurrent.activityBA));
 BA.debugLineNum = 543;BA.debugLine="p.Width = 200%x";
Debug.ShouldStop(1073741824);
drama.mostCurrent._p.runMethod(true,"setWidth",drama.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 200)),drama.mostCurrent.activityBA));
 BA.debugLineNum = 544;BA.debugLine="ScrollView1.Panel.Height = p.Height";
Debug.ShouldStop(-2147483648);
drama.mostCurrent._scrollview1.runMethod(false,"getPanel").runMethod(true,"setHeight",drama.mostCurrent._p.runMethod(true,"getHeight"));
 BA.debugLineNum = 546;BA.debugLine="Panel2.Visible = True";
Debug.ShouldStop(2);
drama.mostCurrent._panel2.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 547;BA.debugLine="Panel3.Visible = True";
Debug.ShouldStop(4);
drama.mostCurrent._panel3.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 548;BA.debugLine="Panel4.Visible = True";
Debug.ShouldStop(8);
drama.mostCurrent._panel4.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 549;BA.debugLine="Panel5.Visible = True";
Debug.ShouldStop(16);
drama.mostCurrent._panel5.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 550;BA.debugLine="Panel6.Visible = True";
Debug.ShouldStop(32);
drama.mostCurrent._panel6.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 551;BA.debugLine="Panel7.Visible = True";
Debug.ShouldStop(64);
drama.mostCurrent._panel7.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 552;BA.debugLine="Panel8.Visible = True";
Debug.ShouldStop(128);
drama.mostCurrent._panel8.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 553;BA.debugLine="Panel9.Visible = True";
Debug.ShouldStop(256);
drama.mostCurrent._panel9.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 554;BA.debugLine="Panel10.Visible = True";
Debug.ShouldStop(512);
drama.mostCurrent._panel10.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 555;BA.debugLine="Panel11.Visible = True";
Debug.ShouldStop(1024);
drama.mostCurrent._panel11.runMethod(true,"setVisible",drama.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 557;BA.debugLine="Drama1.Text = \"Kramer vs. Kramer\"";
Debug.ShouldStop(4096);
drama.mostCurrent._drama1.runMethod(true,"setText",BA.ObjectToCharSequence("Kramer vs. Kramer"));
 BA.debugLineNum = 558;BA.debugLine="Starter1.Text = \"Starring: Dustin Hoffman, Meryl";
Debug.ShouldStop(8192);
drama.mostCurrent._starter1.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Dustin Hoffman, Meryl Streep, Justin Henry"));
 BA.debugLineNum = 559;BA.debugLine="Year1.Text = \"(1979)\"";
Debug.ShouldStop(16384);
drama.mostCurrent._year1.runMethod(true,"setText",BA.ObjectToCharSequence("(1979)"));
 BA.debugLineNum = 560;BA.debugLine="OverView1.Text = \"In this emotionally charged co";
Debug.ShouldStop(32768);
drama.mostCurrent._overview1.runMethod(true,"setText",BA.ObjectToCharSequence("In this emotionally charged courtroom and family drama, Kramer vs. Kramer refers to the heartbreaking custody battle between Ted Kramer, a man forced into single fatherhood, and Joanna Kramer, the wife who returns after abandoning their son. As love, responsibility, and personal growth collide, the film asks: what defines a good parent?"));
 BA.debugLineNum = 562;BA.debugLine="Drama2.Text = \"Manchester by the Sea\"";
Debug.ShouldStop(131072);
drama.mostCurrent._drama2.runMethod(true,"setText",BA.ObjectToCharSequence("Manchester by the Sea"));
 BA.debugLineNum = 563;BA.debugLine="Starter2.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(262144);
drama.mostCurrent._starter2.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Williams, Lucas Hedges"));
 BA.debugLineNum = 564;BA.debugLine="Year2.Text = \"(2016)\"";
Debug.ShouldStop(524288);
drama.mostCurrent._year2.runMethod(true,"setText",BA.ObjectToCharSequence("(2016)"));
 BA.debugLineNum = 565;BA.debugLine="OverView2.Text = \"After the death of his brother";
Debug.ShouldStop(1048576);
drama.mostCurrent._overview2.runMethod(true,"setText",BA.ObjectToCharSequence("After the death of his brother, a withdrawn and guilt-ridden janitor is forced to return to his hometown and take care of his teenage nephew. As buried trauma resurfaces, he must face his tragic past and confront the limits of personal healing."));
 BA.debugLineNum = 567;BA.debugLine="Drama6.Text = \"Gone Baby Gone\"";
Debug.ShouldStop(4194304);
drama.mostCurrent._drama6.runMethod(true,"setText",BA.ObjectToCharSequence("Gone Baby Gone"));
 BA.debugLineNum = 568;BA.debugLine="Starter6.Text = \"Starring: Casey Affleck, Michel";
Debug.ShouldStop(8388608);
drama.mostCurrent._starter6.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Casey Affleck, Michelle Monaghan, Morgan Freeman"));
 BA.debugLineNum = 569;BA.debugLine="Year6.Text = \"(2007)\"";
Debug.ShouldStop(16777216);
drama.mostCurrent._year6.runMethod(true,"setText",BA.ObjectToCharSequence("(2007)"));
 BA.debugLineNum = 570;BA.debugLine="OverView6.Text = \"In a tough Boston neighborhood";
Debug.ShouldStop(33554432);
drama.mostCurrent._overview6.runMethod(true,"setText",BA.ObjectToCharSequence("In a tough Boston neighborhood, a pair of private detectives investigates the kidnapping of a young girl. As they get closer to the truth, they are forced to question what justice really means, and whether doing the right thing is always right."));
 BA.debugLineNum = 572;BA.debugLine="Drama4.Text = \"Million Dollar Baby\"";
Debug.ShouldStop(134217728);
drama.mostCurrent._drama4.runMethod(true,"setText",BA.ObjectToCharSequence("Million Dollar Baby"));
 BA.debugLineNum = 573;BA.debugLine="Starter4.Text = \"Starring: Morgan Freeman, Hilar";
Debug.ShouldStop(268435456);
drama.mostCurrent._starter4.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Morgan Freeman, Hilary Swank, Clint Eastwood"));
 BA.debugLineNum = 574;BA.debugLine="Year4.Text = \"(2004)\"";
Debug.ShouldStop(536870912);
drama.mostCurrent._year4.runMethod(true,"setText",BA.ObjectToCharSequence("(2004)"));
 BA.debugLineNum = 575;BA.debugLine="OverView4.Text = \"A waitress with dreams of beco";
Debug.ShouldStop(1073741824);
drama.mostCurrent._overview4.runMethod(true,"setText",BA.ObjectToCharSequence("A waitress with dreams of becoming a boxer convinces a reluctant trainer to take her on. As she rises through the ranks, a tragic turn of events forces them both to reckon with loss, dignity, and the nature of love."));
 BA.debugLineNum = 577;BA.debugLine="Drama5.Text = \"The Bridges of Madison County\"";
Debug.ShouldStop(1);
drama.mostCurrent._drama5.runMethod(true,"setText",BA.ObjectToCharSequence("The Bridges of Madison County"));
 BA.debugLineNum = 578;BA.debugLine="Starter5.Text = \"Starring: Clint Eastwood, Meryl";
Debug.ShouldStop(2);
drama.mostCurrent._starter5.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Clint Eastwood, Meryl Streep"));
 BA.debugLineNum = 579;BA.debugLine="Year5.Text = \"(1995)\"";
Debug.ShouldStop(4);
drama.mostCurrent._year5.runMethod(true,"setText",BA.ObjectToCharSequence("(1995)"));
 BA.debugLineNum = 580;BA.debugLine="OverView5.Text = \"A brief, passionate romance be";
Debug.ShouldStop(8);
drama.mostCurrent._overview5.runMethod(true,"setText",BA.ObjectToCharSequence("A brief, passionate romance between a lonely housewife and a traveling photographer leads to a life-changing emotional journey. Set against the backdrop of 1960s Iowa, it’s a heartbreaking story about missed chances and enduring love."));
 BA.debugLineNum = 582;BA.debugLine="Drama3.Text = \"The Master\"";
Debug.ShouldStop(32);
drama.mostCurrent._drama3.runMethod(true,"setText",BA.ObjectToCharSequence("The Master"));
 BA.debugLineNum = 583;BA.debugLine="Starter3.Text = \"Starring: Philip Seymour Hoffma";
Debug.ShouldStop(64);
drama.mostCurrent._starter3.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Philip Seymour Hoffman, Joaquin Phoenix, Amy Adams"));
 BA.debugLineNum = 584;BA.debugLine="Year3.Text = \"(2012)\"";
Debug.ShouldStop(128);
drama.mostCurrent._year3.runMethod(true,"setText",BA.ObjectToCharSequence("(2012)"));
 BA.debugLineNum = 585;BA.debugLine="OverView3.Text = \"A mentally unstable WWII veter";
Debug.ShouldStop(256);
drama.mostCurrent._overview3.runMethod(true,"setText",BA.ObjectToCharSequence("A mentally unstable WWII veteran is drawn to a charismatic cult leader and his belief system. As their relationship grows, the film explores themes of control, identity, and the search for meaning in a post-war world."));
 BA.debugLineNum = 587;BA.debugLine="Drama7.Text = \"Blue Jasmine\"";
Debug.ShouldStop(1024);
drama.mostCurrent._drama7.runMethod(true,"setText",BA.ObjectToCharSequence("Blue Jasmine"));
 BA.debugLineNum = 588;BA.debugLine="Starter7.Text = \"Starring: Cate Blanchett, Sally";
Debug.ShouldStop(2048);
drama.mostCurrent._starter7.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Cate Blanchett, Sally Hawkins, Alec Baldwin"));
 BA.debugLineNum = 589;BA.debugLine="Year7.Text = \"(2013)\"";
Debug.ShouldStop(4096);
drama.mostCurrent._year7.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 590;BA.debugLine="OverView7.Text = \"After losing her fortune and s";
Debug.ShouldStop(8192);
drama.mostCurrent._overview7.runMethod(true,"setText",BA.ObjectToCharSequence("After losing her fortune and status, a New York socialite is forced to move in with her working-class sister. As her mental state deteriorates, her desperate attempts to reclaim her old life unravel into tragic self-destruction."));
 BA.debugLineNum = 592;BA.debugLine="Drama8.Text = \"Her\"";
Debug.ShouldStop(32768);
drama.mostCurrent._drama8.runMethod(true,"setText",BA.ObjectToCharSequence("Her"));
 BA.debugLineNum = 593;BA.debugLine="Starter8.Text = \"Starring: Joaquin Phoenix, Roon";
Debug.ShouldStop(65536);
drama.mostCurrent._starter8.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Joaquin Phoenix, Rooney Mara, Amy Adams"));
 BA.debugLineNum = 594;BA.debugLine="Year8.Text = \"(2013)\"";
Debug.ShouldStop(131072);
drama.mostCurrent._year8.runMethod(true,"setText",BA.ObjectToCharSequence("(2013)"));
 BA.debugLineNum = 595;BA.debugLine="OverView8.Text = \"In a near-future Los Angeles,";
Debug.ShouldStop(262144);
drama.mostCurrent._overview8.runMethod(true,"setText",BA.ObjectToCharSequence("In a near-future Los Angeles, a lonely man finds solace in a hyper-intelligent AI voice. As their bond deepens into love, he’s forced to question what it means to be human and whether artificial connection is real connection."));
 BA.debugLineNum = 597;BA.debugLine="Drama9.Text = \"Carol\"";
Debug.ShouldStop(1048576);
drama.mostCurrent._drama9.runMethod(true,"setText",BA.ObjectToCharSequence("Carol"));
 BA.debugLineNum = 598;BA.debugLine="Starter9.Text = \"Starring: Rooney Mara, Cate Bla";
Debug.ShouldStop(2097152);
drama.mostCurrent._starter9.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Rooney Mara, Cate Blanchett, Sarah Paulson"));
 BA.debugLineNum = 599;BA.debugLine="Year9.Text = \"(2015)\"";
Debug.ShouldStop(4194304);
drama.mostCurrent._year9.runMethod(true,"setText",BA.ObjectToCharSequence("(2015)"));
 BA.debugLineNum = 600;BA.debugLine="OverView9.Text = \"A chance encounter between a y";
Debug.ShouldStop(8388608);
drama.mostCurrent._overview9.runMethod(true,"setText",BA.ObjectToCharSequence("A chance encounter between a young aspiring photographer and a glamorous older woman sparks an unexpected romance. Set in the 1950s, this tale of forbidden love explores identity, societal expectations, and emotional resilience."));
 BA.debugLineNum = 602;BA.debugLine="Drama10.Text = \"The Lost Daughter\"";
Debug.ShouldStop(33554432);
drama.mostCurrent._drama10.runMethod(true,"setText",BA.ObjectToCharSequence("The Lost Daughter"));
 BA.debugLineNum = 603;BA.debugLine="Starter10.Text = \"Starring: Olivia Colman, Dakot";
Debug.ShouldStop(67108864);
drama.mostCurrent._starter10.runMethod(true,"setText",BA.ObjectToCharSequence("Starring: Olivia Colman, Dakota Johnson, Jessie Buckley"));
 BA.debugLineNum = 604;BA.debugLine="Year10.Text = \"(2021)\"";
Debug.ShouldStop(134217728);
drama.mostCurrent._year10.runMethod(true,"setText",BA.ObjectToCharSequence("(2021)"));
 BA.debugLineNum = 605;BA.debugLine="OverView10.Text = \"A solitary woman on vacation";
Debug.ShouldStop(268435456);
drama.mostCurrent._overview10.runMethod(true,"setText",BA.ObjectToCharSequence("A solitary woman on vacation becomes fascinated by a young mother and her daughter, triggering memories of her own past choices as a parent. The film dives into the complexities of motherhood, regret, and identity"));
 };
