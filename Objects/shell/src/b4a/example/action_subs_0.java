...
try {
		Debug.PushSubsStack("Activity_Create (action) ","action",3,action.mostCurrent.activityBA,action.mostCurrent,18);
...
try {
		Debug.PushSubsStack("Activity_Pause (action) ","action",3,action.mostCurrent.activityBA,action.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Activity_Resume (action) ","action",3,action.mostCurrent.activityBA,action.mostCurrent,24);
