...
public static b4a.example.scifi _scifi = null;
  public Object[] GetGlobals() {
		return new Object[] {"Action",Debug.moduleToString(b4a.example.action.class),"Activity",drama.mostCurrent._activity,"ImageView1",drama.mostCurrent._imageview1,"Label1",drama.mostCurrent._label1,"Label2",drama.mostCurrent._label2,"Main",Debug.moduleToString(b4a.example.main.class),"SciFi",Debug.moduleToString(b4a.example.scifi.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}