...
RDebugUtils.currentLine=1048625;
 //BA.debugLineNum = 1048625;BA.debugLine="ScrollView1.Panel.AddView(p, 0, 0, 200%x, 170%y)";
mostCurrent._scrollview1.getPanel().AddView((android.view.View)(_p.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (200),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (170),mostCurrent.activityBA));
